...
//             .bindPopup(`<h2>${feature.properties.name}, ${feature.properties.country}<hr>${feature.properties.city}</h2>`);
//     }
//   }).addTo(map);
...
let torontoHoods = "https://raw.githubusercontent.com/Ehsan-O/Mapping_Earthquakes/main/torontoNeighborhoods.json";
